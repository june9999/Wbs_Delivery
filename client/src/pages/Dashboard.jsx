...
const Dashboard = () => {
  ...
  return (
    ...
    <section className="flex max-w-screen-xxl mx-auto pb-[2rem] bg-gradient-to-b from-primary-50 to-primary-100">
      <div>
        <NavbarSide displayPage={displayPage} setDisplayPage={setDisplayPage} />
      </div>
      <div className="flex-col pt-[2rem] bg-gradient-to-b from-primary-50 to-primary-100">
