...
const NavbarSide = ({ displayPage, setDisplayPage }) => {
  ...
  return (
    <>
      ...
      > */}
      {sidedisplay && (
        <div className="overflow-y-auto py-5 px-3 h-full bg-gradient-to-t from-primary-50 to-primary-100 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
