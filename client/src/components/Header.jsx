        ...
        <div className="px-4 py-2 lg:px-6 flex flex-wrap justify-between items-center mx-auto max-w-screen-xxl pb-2">
          ...
          {user ? (
            <div className="flex items-center lg:order-2">
              ...
              <div className="text-gray-800 dark:text-white bg-primary-100 hover:bg-primary-200 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 shadow-xl">
